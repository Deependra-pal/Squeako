...
export default function MultipleViews() {
  ...
  // Animation on tab panel transition
  useEffect(() => {
    if (panelRef.current) {
    ...
    <div ref={containerRef} className="bg-views-section py-20 px-0 relative">
      <div className="max-w-[1200px] mx-auto px-[22px] relative z-10">
        <div className="py-2">
          ...
          {/* Navigation Tabs */}
          <div className="views-tab-container flex flex-wrap justify-center gap-[9px] mb-9">
            {tabs.map((tab) => (
              <button
                key={tab.id}
