  ...
  return (
    <div className="py-20 px-0">
      <div className="max-w-[1200px] mx-auto px-[22px] reveal">
        ...
        {/* Calculator Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-11 items-center bg-[#112222]/40 border border-hairline/60 rounded-[30px] p-6 lg:p-11 shadow-sh-sm">
          {/* Controls */}
          <div className="flex flex-col">
                ...
                {TOOLS.map((tool) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-[10px] w-full border-[1.5px] rounded-[14px] p-[10px] px-3 bg-white cursor-pointer transition-all duration-150 text-left relative focus:outline-none ${isSelected
                        ? 'border-[#16D196] ring-4 ring-[#16D196]/20'
                        : 'border-hairline hover:border-[#16D196]/50'
                        }`}
                    >
                      <span
                      ...
                      <span
                        className={`absolute right-3 top-1/2 -translate-y-1/2 text-[0.95rem] font-black text-violet transition-opacity duration-150 ${isSelected ? 'opacity-100' : 'opacity-0'
                          }`}
                      >
                        ✓
                      </span>
            ...
            {/* Result Display Box */}
            <div className="bg-white border-[1.5px] border-hairline rounded-[20px] p-[22px] shadow-sh-sm flex flex-col gap-2.5">
              <div className="flex flex-col gap-2 mb-[14px]">
                {selectedTools.length > 0 ? (
                  activeToolsData.map((tool) => (
                    <div className="flex justify-between items-center text-[0.88rem]" key={tool.name}>
              ...
              <div className="flex justify-between items-center py-2.5 border-t-2 border-hairline pt-3.5">
              ...
              <div className="flex justify-between items-center py-2.5 border-t border-hairline/60">
              ...
              {/* Savings Highlight */}
              <div className="bg-mint-wash border border-[#bdf0dd] rounded-[14px] p-[18px] text-center mt-3">
